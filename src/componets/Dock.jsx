...
const Dock = ({windowsState, setWindowsState}) => {
  return (
    <footer className="dock">
        <div 
 onClick={() => { setWindowsState(state => ({ ...state, github: true })) }}        className='icon github'><img src="/doc-icons/github.svg" alt=''/></div>
        <div
        ...
        <div
         onClick={()=>{window.open("mailto:nigamshivanshu297@gmail.com","_blank")}}
        className='icon mail'><img src="/doc-icons/mail.svg" alt=''/></div>
        <div 
          onClick={()=>{window.open("https://www.linkedin.com/in/shivanshunigam","_blank")}}
